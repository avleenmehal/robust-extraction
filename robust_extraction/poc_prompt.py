...
def main():
    ...
    sample_paper = """
    The wastewater treatment plant operated at a temperature of 20°C with a pH of 7.
    The influent phosphorus concentration was 8 mg/L. After treatment with a chemical
